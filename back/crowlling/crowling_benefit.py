...
try:
    driver.get('https://www.card-gorilla.com/search/card?cate=CRD') #카드고릴라 신용카드 조회 976개
    ...
    for idx, li in enumerate(li_list):
        ...
        try:
            ...
            for dl in dl_list:
                ...
                fields={}
                fields['credit_card_category_id']=cnt
                cnt +=1 
    ...
    # Json 파일을 저장할 경로
    card_ben_list_file_path = './credit_card_category.json'

    card_ben_list_file_csv_path = './credit_card_category.csv'

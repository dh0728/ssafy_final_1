...
try:
    driver.get('https://www.card-gorilla.com/search/card?cate=CHK') #카드고릴라 신용카드 조회 976개
    ...
    for idx, li in enumerate(li_list):
        ...
        #         card_to_category={}
        #         card_to_category['model']="cards.credit_card_category"
        #         ctoc_fields={}
        #         ctoc_fields['credit_card_category_id']=len(card_ben_list)+1
        #         ctoc_fields['credit_card_id']=idx+1
        ...
        #             ctoc_fields['category_id']=kinds.index(title)+1
        #         except:
        #             title = "No"
        ...
        #             ctoc_fields['desc_detail']=detail_desc
        #         except:
        #             detail_desc = "No"
        
        #         # 혜택 정보 저장
        #         # pprint(benefit)
        #         card_to_category['fields']=ctoc_fields
        #         # 전체 카드 데이터에 주요 혜택 저장

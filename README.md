...
### 🔔메인페이지 ###
<p>
  <img src="./images/가계북_메인페이지.gif" width="75%" height="75%"title="px(픽셀) 크기 설정"alt="main_page"></img>
</p>

### 📌카드 조회 ###
<p>
  <img src="./images/가계북_카드조회.gif" width="75%" height="75%"title="px(픽셀) 크기 설정"alt="main_page"></img>
</p>
...
#### 달력 ####
<p>
  <img src="./images/가계북_캘린더_기본.gif" width="75%" height="75%"title="px(픽셀) 크기 설정"alt="main_page"></img>
</p>

#### 내역 ####
<p>
  <img src="./images/가계북_캘린더_내역추가.gif" width="75%" height="75%"title="px(픽셀) 크기 설정"alt="main_page"></img>
</p>

#### 예산 ####
<p>
  <img src="./images/가계북_캘린더_예산.gif" width="75%" height="75%"title="px(픽셀) 크기 설정"alt="main_page"></img>
</p>

#### 금융일정정 ####
<p>
  <img src="./images/가계북_캘린더_금융일정.gif" width="75%" height="75%"title="px(픽셀) 크기 설정"alt="main_page"></img>
</p>
